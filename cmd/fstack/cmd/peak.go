...
// peakCmd represents the peak command
var peakCmd = &cobra.Command{
	Use:   "peak",
	Short: "PEAK opertation for stack",
	Long:  `Get last message from top of stack, print it but NOT remove. Headers are printed to Stderr, body to Stdout`,
